class RoomUsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @room_user.save
        format.html { redirect_to room_user_url(@room_user), notice: "Room user was successfully created." }
  ...
  def update
    respond_to do |format|
      if @room_user.update(room_user_params)
        format.html { redirect_to room_user_url(@room_user), notice: "Room user was successfully updated." }
